...
class RecommendationExportService:
    ...
    def export_png(self, file_path, recommendations, version="1.2.0"):
    ...
    def export_pdf(self, file_path, recommendations, version="1.2.0"):
        self._validate_recommendations(recommendations)
    ...
    def export_txt(self, file_path, recommendations, version="1.2.0"):
        self._validate_recommendations(recommendations)
